...
<div class="in modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title" id="addPegawai"><i class="align-middle me-2" data-feather="plus"></i> Pegawai</h5>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <form action="controller/profile_p.php?role=TAMBAH_PEGAWAI" method="POST" enctype="multipart/form-data">
